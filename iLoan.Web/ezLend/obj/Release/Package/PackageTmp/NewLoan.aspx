<%@ Page Title="Money Loandering - Create/Edit Loan" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewLoan.aspx.cs" Inherits="ezLend.NewLoan" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (id != null && id < 0) {
                ...
                $('#liStat').text('Edit Loan');
                $('#slideAmount').parent().parent().hide();

                $('#<%=ddlLoanTerm.ClientID%>').attr('disabled', 'disabled');
                $('#<%=ddlComaker.ClientID%>').attr('disabled', 'disabled');
                ...
                $('#<%=txtInterest.ClientID%>').attr('readonly', 'true');
                $('#<%=txtPeriod.ClientID%>').attr('readonly', 'true');
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div class="page-head">
		...
		<ol class="breadcrumb">
            ...
            <li id='liStat' class="active">Create Loan</li>
		</ol>
	</div>
    <div class="cl-mcont">
        <div class="row">
