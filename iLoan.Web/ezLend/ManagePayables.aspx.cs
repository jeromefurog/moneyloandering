    ...
    public partial class ManagePayables : System.Web.UI.Page
    {
        ...
        private void PopulateCurrentGrid()
        {
            ...
            if (dtVw != null)
            {
                ...
                object sumObject;
                sumObject = dtVw.Compute("SUM(realamount)","");
                decimal val = (decimal)sumObject;
                lblCurrent.Text = val.ToString("0,0.00", CultureInfo.InvariantCulture);
        ...
        private void PopulateOverDueGrid()
        {
            ...
            if (dtVw != null)
            {
                ...
                sumObject = dtVw.Compute("SUM(realamount)", "");
                decimal val = (decimal)sumObject;
                lblOverdue.Text = val.ToString("0,0.00", CultureInfo.InvariantCulture);
            }
        ...
        private void PopulatePendingGrid()
        {
            ...
            if (dtVw != null)
            {
                ...
                sumObject = dtVw.Compute("SUM(realamount)", "");
                decimal val = (decimal)sumObject;
                lblPending.Text = val.ToString("0,0.00", CultureInfo.InvariantCulture);
