...
namespace ezLend
{
    public partial class ManageInvestors : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect(string.Format("NewInvestor.aspx?id={0}", Utility.EncryptQueryString(HttpUtility.UrlEncode("-1"))));
        }
