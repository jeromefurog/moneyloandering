<%@ Page Title="LoanMac - Manage User" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ManageInvestors.aspx.cs" Inherits="LoanMac.Web.ManageInvestors" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div class="header">
        ...
        <h2>Search, create and edit investments</h2>
    </div>
    ...
    <div class="content">
        ...
        <div class="pure-form">
            ...
            <asp:Button ID="btnNew" class="pure-button pure-button-primary" runat="server" Text="New Investor" onclick="btnNew_Click" />
        ...
        <asp:GridView ID="grdView" runat="server" AllowPaging="True" OnPageIndexChanging="grid_PageIndexChanging" AutoGenerateColumns="False" EmptyDataText="No records found" Width="100%" class="pure-table" PageSize="10">                      
            ...
            <Columns>                 
                <asp:TemplateField HeaderText="Investment Id" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:HyperLink ID="hlId" runat="server" 
                            NavigateUrl='<%# string.Format("~/NewInvestor.aspx?id={0}", LoanMac.Core.Utility.EncryptQueryString(HttpUtility.UrlEncode(Eval("id").ToString()))) %>' 
                            Text='<%# Eval("id") %>'></asp:HyperLink>                                    
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Investor Name" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:HyperLink ID="hlId" runat="server" 
